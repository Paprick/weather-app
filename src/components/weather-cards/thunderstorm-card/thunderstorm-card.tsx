...
import { Rain } from '@components/weather-components/rain/rain'
import { Thunder } from '@components/weather-components/thunder/thunder'
...
export const ThunderstormCard: React.FC<Props> = ({ isNight = false, intensity = 'heavy' }) => {
